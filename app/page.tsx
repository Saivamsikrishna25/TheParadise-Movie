...
/* ======================================================
   HOME PAGE - FULLY RESPONSIVE & FIXED
====================================================== */
export default function Home() {
  ...
  const pauseAllVideos = () => {
    Object.values(videoRefs.current).forEach((iframe) => {
      if (iframe && iframe.contentWindow) {
        // Send pause command to YouTube iframes
  ...
  return (
    <>
      ...
      {/* ======================================================
         ENHANCED HAMBURGER MENU BUTTON (Top Left) - z-[70]
      ====================================================== */}
      <button
      ...
      {/* ======================================================
         ENHANCED MOBILE MENU OVERLAY - z-[69]
      ====================================================== */}
      <div
        className={`fixed inset-0 z-[69] bg-gradient-to-br from-black via-red-950/30 to-black backdrop-blur-xl transition-all duration-500 overflow-y-auto ${
      ...
      >
        ...
        <div className="relative flex flex-col items-center justify-start min-h-screen gap-3 sm:gap-4 p-6 sm:p-8 pt-20 sm:pt-24 pb-12 sm:pb-16">
          <div className="mb-4 sm:mb-6 text-center">
            <h2 className="text-3xl sm:text-4xl md:text-5xl font-black bg-gradient-to-r from-red-500 via-orange-500 to-red-600 bg-clip-text text-transparent mb-2">
              THE PARADISE
            </h2>
          ...
          <div className="mt-6 sm:mt-8 w-full max-w-md">
            <h3 className="text-xl sm:text-2xl font-bold text-center mb-3 sm:mb-4 text-red-500">
              📅 Quick Updates
            </h3>
            <div className="bg-white/5 backdrop-blur-sm rounded-2xl p-4 sm:p-6 border border-red-500/30">
              <div className="space-y-3 sm:space-y-4">
                <div className="flex items-start gap-2 sm:gap-3">
                  ...
                  <div>
                    <p className="text-white font-bold text-sm sm:text-base">World Premiere</p>
                    <p className="text-gray-400 text-xs sm:text-sm">August 20, 2026</p>
                  </div>
                </div>
                <div className="flex items-start gap-2 sm:gap-3">
                  <span className="text-xl sm:text-2xl">🎭</span>
                  <div>
                    <p className="text-white font-bold text-sm sm:text-base">Worldwide Release</p>
                    <p className="text-gray-400 text-xs sm:text-sm">August 21, 2026</p>
                  </div>
                </div>
                <div className="flex items-start gap-2 sm:gap-3">
                  <span className="text-xl sm:text-2xl">🎤</span>
                  <div>
                    <p className="text-white font-bold text-sm sm:text-base">Pre-Release Event</p>
                    <p className="text-gray-400 text-xs sm:text-sm">August 15, 2026</p>
                  </div>
                </div>
              </div>
            </div>
      ...
      {/* ======================================================
         STICKY NAVIGATION BAR (Desktop) - z-[65] INCREASED
      ====================================================== */}
      <nav
      ...
      >
        ...
        <div className="relative min-h-screen flex flex-col justify-center items-center text-center px-3 sm:px-4 text-white pt-0">
          ...
          <div
            className="mt-4 sm:mt-6 px-3 sm:px-4 md:px-8 py-2 sm:py-3 bg-gradient-to-r from-red-600/30 to-orange-600/30 border-2 border-red-500/50 rounded-full backdrop-blur-sm animate-fadeInUp shadow-lg shadow-red-500/20"
          ...
          <div
            className="mt-6 sm:mt-8 md:mt-12 grid grid-cols-2 sm:flex gap-2 sm:gap-3 md:gap-4 lg:gap-6 animate-fadeInUp px-2"
          ...
          >
            {Object.entries(timeLeft).map(([label, value], index) => (
              ...
              >
                <p className="text-2xl sm:text-3xl md:text-4xl lg:text-5xl font-black group-hover:text-red-500 transition-colors duration-300 tabular-nums">
                  {value}
                </p>
                <span className="text-[10px] sm:text-xs uppercase text-gray-400 tracking-widest font-semibold mt-0.5 sm:mt-1 block group-hover:text-red-400 transition-colors">
                  {label}
                </span>
              </div>
            ))}
          ...
          >
            ...
            >
              ...
              <svg
                className="w-4 h-4 sm:w-5 sm:h-5 md:w-6 md:h-6 relative group-hover:scale-125 transition-transform"
                fill="currentColor"
                viewBox="0 0 20 20"
              >
                <path d="M6.3 2.841A1.5 1.5 0 004 4.11V15.89a1.5 1.5 0 002.3 1.269l9.344-5.89a1.5 1.5 0 000-2.538L6.3 2.84z" />
              </svg>
              <span className="relative text-sm sm:text-base md:text-lg">
                WATCH VIDEOS
              </span>
            </button>
      ...
      <FadeInSection>
        <section
          id="story"
          className="bg-gradient-to-b from-black via-red-950/10 to-black text-white py-16 sm:py-20 md:py-24 px-4 sm:px-6"
        >
      ...
      {/* ======================================================
         EVENTS AND UPDATES SECTION - MOBILE RESPONSIVE
      ====================================================== */}
      <FadeInSection>
        <section
          id="events"
          className="bg-black text-white py-16 sm:py-20 md:py-24 px-4 sm:px-6 border-t border-red-500/20"
        >
          <div className="max-w-7xl mx-auto">
            ...
            <div className="grid md:grid-cols-2 gap-6 sm:gap-8">
              ...
              <div className="bg-gradient-to-br from-red-950/20 to-black rounded-xl sm:rounded-2xl p-4 sm:p-5 md:p-6 border-2 border-red-500/30">
                <h3 className="text-xl sm:text-2xl font-bold mb-4 sm:mb-6 text-red-500 flex items-center gap-2 sm:gap-3">
                ...
                <div className="space-y-3 sm:space-y-4 max-h-[500px] sm:max-h-[600px] overflow-y-auto pr-2 sm:pr-4 custom-scrollbar">
                  {eventsData.map((event, index) => (
                    <div
                      key={index}
                      className="bg-gradient-to-br from-black/50 to-red-950/20 rounded-lg sm:rounded-xl p-3 sm:p-4 md:p-5 border border-red-500/20 hover:border-red-500 transition-all duration-300 hover:scale-[1.02] group cursor-pointer"
                    >
                      <div className="flex items-start gap-2 sm:gap-3 md:gap-4">
                        ...
                        <div className="flex-1 min-w-0">
                          <h4 className="text-base sm:text-lg font-bold mb-1 group-hover:text-red-500 transition">
                            {event.title}
                          </h4>
                          <p className="text-red-400 text-xs sm:text-sm mb-2 font-semibold">
                            {event.date}
                          </p>
                          ...
                          {event.tag && (
                            <span className="inline-block mt-2 px-2 sm:px-3 py-0.5 sm:py-1 bg-red-500/20 text-red-400 text-[10px] sm:text-xs rounded-full border border-red-500/30">
                              {event.tag}
                            </span>
                          )}
                        </div>
                ...
                <div className="space-y-3 sm:space-y-4 max-h-[500px] sm:max-h-[600px] overflow-y-auto pr-2 sm:pr-4 custom-scrollbar">
                  {eventsVideos.map((video, index) => {
                    ...
                    return (
                      <div
                        key={index}
                        className="bg-gradient-to-br from-black/50 to-red-950/20 rounded-lg sm:rounded-xl overflow-hidden border border-red-500/20 hover:border-red-500 transition-all duration-300 hover:scale-[1.02] group"
                      >
                        ...
                        <div className="p-3 sm:p-4">
                          <h4 className="font-bold text-sm sm:text-base text-white group-hover:text-red-500 transition flex items-center gap-2">
      ...
      <FadeInSection>
        <section
          id="cast"
          className="bg-gradient-to-b from-black via-red-950/10 to-black text-white py-16 sm:py-20 md:py-24 px-3 sm:px-4"
        >
          <div className="mb-8 sm:mb-10 md:mb-12 text-center">
            <h2 className="text-3xl sm:text-4xl md:text-5xl font-black mb-3 sm:mb-4 text-white">
              The Cast
          ...
          <div className="max-w-7xl mx-auto grid grid-cols-2 sm:grid-cols-3 md:grid-cols-4 gap-4 sm:gap-6 md:gap-8">
            {cast.slice(0, 4).map((actor, index) => (
              <div
                key={actor.name}
                className="bg-gradient-to-b from-red-950/20 to-black rounded-xl sm:rounded-2xl overflow-hidden text-center hover:scale-110 transition-all duration-300 group cursor-pointer border-2 border-red-500/20 hover:border-red-500 shadow-lg hover:shadow-2xl hover:shadow-red-500/30 animate-fadeInUp"
                style={{ animationDelay: `${index * 0.1}s` }}
              >
                ...
                <div className="p-3 sm:p-4 bg-gradient-to-b from-red-950/40 to-black">
                  <h3 className="font-bold text-base sm:text-lg group-hover:text-red-500 transition truncate">
                    {actor.name}
                  </h3>
        ...
        <section id="gallery" className="bg-black text-white py-16 sm:py-20 md:py-24 px-3 sm:px-4">
          ...
          <div className="max-w-7xl mx-auto grid grid-cols-2 md:grid-cols-4 gap-3 sm:gap-4 md:gap-6">
            {galleryImages.slice(0, 4).map((image, index) => (
              <div
                key={image.id}
                className="aspect-[3/4] rounded-xl sm:rounded-2xl overflow-hidden border-2 border-red-500/20 hover:border-red-500 transition-all duration-300 hover:scale-105 cursor-pointer group animate-fadeInUp shadow-lg hover:shadow-2xl hover:shadow-red-500/30 relative"
                style={{ animationDelay: `${index * 0.1}s` }}
              >
                <img
                  src={image.src}
          ...
          <div className="max-w-4xl mx-auto text-center">
            ...
            <div className="flex justify-center gap-4 sm:gap-6 md:gap-8 flex-wrap">
              <a
                ...
                className="group flex flex-col items-center gap-2 sm:gap-3 bg-gradient-to-b from-red-950/20 to-black rounded-xl sm:rounded-2xl p-4 sm:p-5 md:p-6 border-2 border-red-500/20 hover:border-red-500 transition-all duration-300 hover:scale-110 hover:shadow-2xl hover:shadow-red-500/30 w-28 sm:w-32 md:w-auto"
              >
                ...
                <span className="font-bold text-sm sm:text-base md:text-lg group-hover:text-red-500 transition">
                  Instagram
                </span>
              </a>
              ...
              >
                ...
                <span className="font-bold text-sm sm:text-base md:text-lg group-hover:text-red-500 transition text-center">
                  BookMyShow
                </span>
              </a>
            </div>
      ...
      {/* ======================================================
         VIDEOS MODAL - WITH VIDEO PAUSE CONTROL
      ====================================================== */}
      {showVideos && (
              ...
              <div className="flex flex-wrap justify-center gap-2 sm:gap-3 md:gap-4 mb-6 sm:mb-8 md:mb-10 px-2">
                {videoCategories.map((category, index) => (
                  <button
                    ...
                    className={`px-3 sm:px-4 md:px-6 py-2 sm:py-2.5 md:py-3 rounded-full font-bold transition-all transform hover:scale-110 animate-fadeInUp border-2 text-xs sm:text-sm md:text-base ${
                    ...
                    style={{ animationDelay: `${index * 0.1}s` }}
                  >
                    <span className="text-base sm:text-lg md:text-xl mr-1 sm:mr-2">{category.icon}</span>
                ...
                {(
                  ...
                  (video: { title: string; url: string }, index: number) => {
                    ...
                    return (
                      <div
                        key={index}
                        className="space-y-2 sm:space-y-3 bg-gradient-to-b from-red-950/20 to-black rounded-xl sm:rounded-2xl p-3 sm:p-4 md:p-5 border-2 border-red-500/20 hover:border-red-500 transition-all duration-300 hover:scale-105 animate-fadeInUp shadow-lg hover:shadow-2xl hover:shadow-red-500/30"
                        style={{ animationDelay: `${index * 0.1}s` }}
                      >
      ...
      <footer className="bg-gradient-to-b from-black to-red-950/20 text-gray-400 text-center py-8 sm:py-10 text-xs sm:text-sm border-t border-red-500/20 px-4">
        <div className="max-w-4xl mx-auto">
          <div className="mb-3 sm:mb-4">
            <h3 className="text-xl sm:text-2xl font-black bg-gradient-to-r from-red-500 to-orange-500 bg-clip-text text-transparent mb-2">
              THE PARADISE
            </h3>
          ...
          <div className="mb-4 sm:mb-6">
            ...
            >
              ...
              <div className="relative text-left">
                <span className="block text-sm sm:text-base md:text-lg font-black">
                  HYPE METER
                </span>
                <span className="block text-[10px] sm:text-xs font-normal opacity-90">
      ...
      {/* ======================================================
         REVIEWS / HYPE METER MODAL - MOBILE OPTIMIZED - z-[90]
      ====================================================== */}
      {showReviews && (
        <div
...
/* ======================================================
   DETAIL CARD COMPONENT - MOBILE RESPONSIVE
====================================================== */
function DetailCard({
  label,
  value,
  ...
  return (
    <div className="bg-gradient-to-br from-red-950/20 to-black rounded-xl sm:rounded-2xl p-4 sm:p-5 md:p-6 border-2 border-red-500/20 hover:border-red-500 transition-all duration-300 hover:scale-105 hover:shadow-2xl hover:shadow-red-500/30 group">
      ...
      <p className="text-gray-400 text-[10px] sm:text-xs uppercase tracking-wider mb-1 sm:mb-2 group-hover:text-red-400 transition font-semibold">
        {label}
      </p>
      <p className="text-sm sm:text-base md:text-lg font-bold group-hover:text-white transition">
        {value}
      </p>
    </div>
  );
